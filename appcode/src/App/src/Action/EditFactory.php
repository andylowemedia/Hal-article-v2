...
class EditFactory
{
    public function __invoke(ContainerInterface $container)
    {
        ...
        return new EditAction($config['elasticsearch']['hosts'], $config['api'], $config['featured']['sites'], $dbAdapter, $articleMapper, $articleImageMapper, $articleMediaMapper, $articleCategoryMapper, $articleKeywordMapper, $featuredArticleMapper);
    }
}
